...
#define STFL_HERC_DETECT_PGMINTLOOP      ( STFL_HERC_FIRST_BIT  +   0 )
#define STFL_HERC_HOST_RESOURCE_ACCESS   ( STFL_HERC_FIRST_BIT  +   1 )
#define STFL_HERC_INTERVAL_TIMER         ( STFL_HERC_FIRST_BIT  +   2 )
#define STFL_HERC_LOGICAL_PARTITION      ( STFL_HERC_FIRST_BIT  +   3 )
#define STFL_HERC_MOVE_INVERSE           ( STFL_HERC_FIRST_BIT  +   4 )
#define STFL_HERC_MSA_EXTENSION_1        ( STFL_HERC_FIRST_BIT  +   5 )
#define STFL_HERC_MSA_EXTENSION_2        ( STFL_HERC_FIRST_BIT  +   6 )
#define STFL_HERC_PROBSTATE_DIAGF08      ( STFL_HERC_FIRST_BIT  +   7 )
#define STFL_HERC_QDIO_ASSIST            ( STFL_HERC_FIRST_BIT  +   8 )
#define STFL_HERC_QDIO_TDD               ( STFL_HERC_FIRST_BIT  +   9 )
#define STFL_HERC_QDIO_THININT           ( STFL_HERC_FIRST_BIT  +  10 )
#define STFL_HERC_QEBSM                  ( STFL_HERC_FIRST_BIT  +  11 )
#define STFL_HERC_SIGP_SETARCH_S370      ( STFL_HERC_FIRST_BIT  +  12 )
#define STFL_HERC_SVS                    ( STFL_HERC_FIRST_BIT  +  13 )
#define STFL_HERC_VIRTUAL_MACHINE        ( STFL_HERC_FIRST_BIT  +  14 )
