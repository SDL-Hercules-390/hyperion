...
{
    DIS_FAC_INS( B3DA, "AXTR  B3DA ADD (extended DFP)"                 );
    DIS_FAC_INS( B3D2, "ADTR  B3D2 ADD (long DFP)"                     );
    ...
    DIS_FAC_INS( B3F9, "CXGTR B3F9 CONVERT FROM FIXED (64 to extended DFP)");
    DIS_FAC_INS( B3F1, "CDGTR B3F1 CONVERT FROM FIXED (64 to long DFP)"    );
    ...
    DIS_FAC_INS( B3E9, "CGXTR B3E9 CONVERT TO FIXED (extended DFP to 64)"            );
    DIS_FAC_INS( B3E1, "CGDTR B3E1 CONVERT TO FIXED (long DFP to 64)"                );
    ...
    DIS_FAC_INS( B3D9, "DXTR  B3D9 DIVIDE (extended DFP)"                       );
    DIS_FAC_INS( B3D1, "DDTR  B3D1 DIVIDE (long DFP)"                           );
    ...
    DIS_FAC_INS( B3D8, "MXTR  B3D8 MULTIPLY (extended DFP)"                     );
    DIS_FAC_INS( B3D0, "MDTR  B3D0 MULTIPLY (long DFP)"                         );
    ...
    DIS_FAC_INS( B3DB, "SXTR  B3DB SUBTRACT (extended DFP)"                     );
    DIS_FAC_INS( B3D3, "SDTR  B3D3 SUBTRACT (long DFP)"                         );
