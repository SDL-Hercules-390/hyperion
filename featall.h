...
#undef FEATURE_INTERLOCKED_ACCESS_FACILITY_1                    /*810*/
...
#undef FEATURE_LONG_DISPLACEMENT_FACILITY
...
#undef FEATURE_STORE_CLOCK_FAST_FACILITY                        /*@Z9*/
#undef FEATURE_STORE_FACILITY_LIST
#undef FEATURE_STORE_FACILITY_LIST_EXTENDED_FACILITY            /*@Z9*/
...
#undef FEATURE_TOD_CLOCK_STEERING_FACILITY                      /*@Z9*/
