 TITLE ' zvector-e6-07-VSRPR (Zvector E6 VRI-f)'
***********************************************************************
*
...
*  shift and round decimal register instruction.
...
SHAMT    DC    HL1'00'          V3 byte 7 shift amount
...
T&TNUM   DC    A(X&TNUM)         address of test routine
         ...
         DC    HL1'&SHAMT'       shift amount - signed char
...
X&TNUM   DS    0F
         ...
         VLEB  V3,SHAMT,7        load shit amount into v3 byte 7
...
*        E672 VSRPR  - VECTOR SHIFT AND ROUND DECIMAL REGISTER
*
*        VRI_F instr,shamt,i4,m5,cc
*              followed by
*              v1 - 16 byte expected result
*              v2 - 16 byte zoned decimal (operand)

*---------------------------------------------------------------------
* VSRPR  - VECTOR SHIFT AND ROUND DECIMAL REGISTER
*---------------------------------------------------------------------
* VSRPR simple + CC checks
*                                    i4=129(iom=1, drd=0 & rdc=1)
*                                    i4=132(iom=1, drd=0 & rdc=4)
*                                    i4=135(iom=1, drd=0 & rdc=7)
*                                    i4=142(iom=1, drd=0 & rdc=14)
*                                    i4=159(iom=1, drd=0 & rdc=31)

*                                    i4=193(iom=1, drd=1 & rdc=1)
*                                    i4=196(iom=1, drd=1 & rdc=4)
*                                    i4=199(iom=1, drd=1 & rdc=7)
*                                    i4=206(iom=1, drd=1 & rdc=14)
*                                    i4=223(iom=1, drd=1 & rdc=31)

         VRI_F VSRPR,0,159,1,2            shamt=0
         DC    XL16'0000000000000000000000000000022C'    V1
         DC    XL16'0000000000000000000000000000022C'    V2

         VRI_F VSRPR,1,159,1,2            shamt=1 (left)
         DC    XL16'0000000000000000000000000000220C'    V1
         DC    XL16'0000000000000000000000000000022C'    V2

         VRI_F VSRPR,7,159,1,2            shamt=7 (left)
         DC    XL16'0000000000000000000000220000000C'    V1
         DC    XL16'0000000000000000000000000000022C'    V2

         VRI_F VSRPR,30,159,1,3            shamt=30 (left) (overflow)
         DC    XL16'2000000000000000000000000000000C'    V1
         DC    XL16'0000000000000000000000000000022C'    V2

         VRI_F VSRPR,50,159,1,3            shamt=50 (left) (overflow)
         DC    XL16'0000000000000000000000000000000C'    V1
         DC    XL16'0000000000000000000000000000022D'    V2

         VRI_F VSRPR,-1,159,1,2           shamt=-1 (right)
         DC    XL16'0000000000000000000000000000002C'    V1
         DC    XL16'0000000000000000000000000000022C'    V2

         VRI_F VSRPR,-1,223,1,2           shamt=-1 (right) drd=1
         DC    XL16'0000000000000000000000000000003C'    V1
         DC    XL16'0000000000000000000000000000028C'    V2

         VRI_F VSRPR,-1,223,1,1           shamt=-1 (right) drd=1
         DC    XL16'0000000000000000000000000000003D'    V1
         DC    XL16'0000000000000000000000000000028D'    V2

         VRI_F VSRPR,-5,223,1,0           shamt=-1 (right) drd=1
         DC    XL16'0000000000000000000000000000000C'    V1 (note: C)
         DC    XL16'0000000000000000000000000000028D'    V2

         VRI_F VSRPR,-31,223,1,1           shamt=-1 (right) drd=1
         DC    XL16'0000000000000000000000000000001D'    V1 (note: C)
         DC    XL16'9999000000000000000000000000028D'    V2

         VRI_F VSRPR,-64,223,1,0           shamt=-1 (right) drd=1
         DC    XL16'0000000000000000000000000000000C'    V1 (note: C)
...
*                                   m5=11 (p2=1, p1=1, cs=1)
         ...
         VRI_F VSRPR,-1,223,3,2     shamt=-1 (right) drd=1 p1=1
         DC    XL16'0000000000000000000000000000003F'    V1
         DC    XL16'0000000000000000000000000000028D'    V2

         VRI_F VSRPR,-1,223,9,2    shamt=-1 (right) drd=1  p2=1 p1=0
         DC    XL16'0000000000000000000000000000003C'    V1
         DC    XL16'0000000000000000000000000000028D'    V2

         VRI_F VSRPR,-1,223,11,2    shamt=-1 (right) drd=1 p2=1 p1=1
         DC    XL16'0000000000000000000000000000003F'    V1
         DC    XL16'0000000000000000000000000000028D'    V2

         VRI_F VSRPR,0,159,3,2            shamt=0          p2=0 p1=1
         DC    XL16'0000000000000000000000000000022F'    V1
         DC    XL16'0000000000000000000000000000022C'    V2

         VRI_F VSRPR,1,159,9,2            shamt=1 (left)   p2=1 p1=0
         DC    XL16'0000000000000000000000000000220C'    V1
         DC    XL16'0000000000000000000000000000022D'    V2

         VRI_F VSRPR,7,159,11,2           shamt=7 (left)   p2=1 p1=1
