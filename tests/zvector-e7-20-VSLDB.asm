...
*  Vector Shift Left Double By Byt instruction.
*
...
*---------------------------------------------------------------------
         ...
         VRI_D VSLDB,3
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFF000000'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0000000000000000 0000000000000000'   v3
        ...
        VRI_D VSLDB,7
         ...
         VRI_D VSLDB,8
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFF08'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'FFFFFFFFFFFFFF08 FFFFFFFFFFFFFFFF'   v3

         VRI_D VSLDB,15
         DC    XL16'0FFFFFFFFFFFFFFF 08FFFFFFFFFFFFFF'   result
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   v2
         DC    XL16'FFFFFFFFFFFFFF08 FFFFFFFFFFFFFFFF'   v3

* Ignore: Bits 0-3 of the fourth operand should contain
*         zeros; otherwise the results are unpredictable.
*
*        VRI_D VSLDB,16
*        DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   result
*        DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
...
*
*        VRI_D VSLDB,17
*        DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFF0'   result
*        DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
*        DC    XL16'F0E0D0C0B0A09010 7060504030201000'   v3
*
*        VRI_D VSLDB,48
