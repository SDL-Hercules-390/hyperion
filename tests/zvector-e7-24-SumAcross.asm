...
*  Vector Sum Across Word, Doubleword and Quadword instructions.
*
...
*Byte
         VRR_C VSUM,0
         DC    XL16'0000000E00000022 000000360000003A'   result
         DC    XL16'0102030405060708 090A0B0C0D0E0F10'   v2
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   v3

         VRR_C VSUM,0
         DC    XL16'000004000000040B 0000002E00000032'   result
         DC    XL16'FFFFFFFFFFFFFFFF 090A0B0C0D0E0F00'   v2
         DC    XL16'010203040C0D0E0F 0102030405060708'   v3

         VRR_C VSUM,0
         DC    XL16'0000037000000265 000004F0000004F4'   result
         DC    XL16'F1E1D1C1B1A19181 FFFFFFFFFFFFFFFF'   v2
         DC    XL16'090A0B0C0D0E0F01 F1F2F3F4F5F6F7F8'   v3

         VRR_C VSUM,0
         DC    XL16'0000002E00000032 000003D6000003DA'   result
         DC    XL16'090A0B0C0D0E0F00 F1F2F3F4F5F6F7F8'   v2
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   v3

*Halfword
         VRR_C VSUM,1
         DC    XL16'0000070A00001316 00001F2200002B1E'   result
         DC    XL16'0102030405060708 090A0B0C0D0E0F10'   v2
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   v3

         VRR_C VSUM,1
         DC    XL16'0002030200020E0D 0000171A00002316'   result
         DC    XL16'FFFFFFFFFFFFFFFF 090A0B0C0D0E0F00'   v2
         DC    XL16'010203040C0D0E0F 0102030405060708'   v3

         VRR_C VSUM,1
         DC    XL16'0001CEAE00015223 0002F3E30002F7E8'   result
         DC    XL16'F1E1D1C1B1A19181 FFFFFFF0FFFFFFF1'   v2
         DC    XL16'090A0B0C0D0E0F01 F1F2F3F4F5F6F7F8'   v3

         VRR_C VSUM,1
         DC    XL16'0000171A00002316 0001F0F20001FCEE'   result
         DC    XL16'090A0B0C0D0E0F00 F1F2F3F4F5F6F7F8'   v2
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   v3
...
*Halfword
         VRR_C VSUMG,1
         DC    XL16'000000000000171C 0000000000003F34'   result
         DC    XL16'0102030405060708 090A0B0C0D0E0F10'   v2
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   v3

         VRR_C VSUMG,1
         DC    XL16'0000000000040E0B 000000000000372C'   result
         DC    XL16'FFFFFFFFFFFFFFFF 090A0B0C0D0E0F00'   v2
         DC    XL16'010203040C0D0E0F 0102030405060708'   v3

         VRR_C VSUMG,1
         DC    XL16'00000000000315C5 000000000004F7F4'   result
         DC    XL16'F1E1D1C1B1A19181 FFFFFFFFFFFFFFFF'   v2
         DC    XL16'090A0B0C0D0E0F01 F1F2F3F4F5F6F7F8'   v3

         VRR_C VSUMG,1
         DC    XL16'000000000000372C 000000000003E2D4'   result
         DC    XL16'090A0B0C0D0E0F00 F1F2F3F4F5F6F7F8'   v2
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   v3

*Wordword
         VRR_C VSUMG,2
         DC    XL16'000000000B0E1114 000000002326291C'   result
         DC    XL16'0102030405060708 090A0B0C0D0E0F10'   v2
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   v3

         VRR_C VSUMG,2
         DC    XL16'000000020C0D0E0D 000000001B1E2114'   result
         DC    XL16'FFFFFFFFFFFFFFFF 090A0B0C0D0E0F00'   v2
         DC    XL16'010203040C0D0E0F 0102030405060708'   v3

         VRR_C VSUMG,2
         DC    XL16'00000001B0917243 00000002F5F6F7D9'   result
         DC    XL16'F1E1D1C1B1A19181 FFFFFFF0FFFFFFF1'   v2
         DC    XL16'090A0B0C0D0E0F01 F1F2F3F4F5F6F7F8'   v3

         VRR_C VSUMG,2
         DC    XL16'000000001B1E2114 00000001F4F7FAEC'   result
         DC    XL16'090A0B0C0D0E0F00 F1F2F3F4F5F6F7F8'   v2
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   v3
...
*Word
         VRR_C VSUMQ,2
         DC    XL16'0000000000000000 00000000292E3328'   result
         DC    XL16'0102030405060708 090A0B0C0D0E0F10'   v2
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   v3

         VRR_C VSUMQ,2
         DC    XL16'0000000000000000 000000021B1E2112'   result
         DC    XL16'FFFFFFFFFFFFFFFF 090A0B0C0D0E0F00'   v2
         DC    XL16'010203040C0D0E0F 0102030405060708'   v3

         VRR_C VSUMQ,2
         DC    XL16'0000000000000000 00000004997A5B38'   result
         DC    XL16'F1E1D1C1B1A19181 FFFFFFFFFFFFFFFF'   v2
         DC    XL16'090A0B0C0D0E0F01 F1F2F3F4F5F6F7F8'   v3

         VRR_C VSUMQ,2
         DC    XL16'0000000000000000 000000020B1014F8'   result
         DC    XL16'090A0B0C0D0E0F00 F1F2F3F4F5F6F7F8'   v2
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   v3

*Doubleword
         VRR_C VSUMQ,3
         DC    XL16'0000000000000000 1316191C1F222518'   result
         DC    XL16'0102030405060708 090A0B0C0D0E0F10'   v2
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   v3

         VRR_C VSUMQ,3
         DC    XL16'0000000000000001 0A0C0E1012141607'   result
         DC    XL16'FFFFFFFFFFFFFFFF 090A0B0C0D0E0F00'   v2
         DC    XL16'010203040C0D0E0F 0102030405060708'   v3

         VRR_C VSUMQ,3
         DC    XL16'0000000000000002 E3D4C5A7A798896A'   result
         DC    XL16'F1E1D1C1B1A19181 FFFFFFF0FFFFFFF1'   v2
         DC    XL16'090A0B0C0D0E0F01 F1F2F3F4F5F6F7F8'   v3

         VRR_C VSUMQ,3
         DC    XL16'0000000000000001 04070A0D101315F8'   result
         DC    XL16'090A0B0C0D0E0F00 F1F2F3F4F5F6F7F8'   v2
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   v3
