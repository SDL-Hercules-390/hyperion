...
*
***********************************************************************
*  This program tests proper functioning of the z/arch E7 VRI-a
*  Vector Generate Byte Mask instruction.
...
*        test routine will be here (from VRI-a macro)
*
*        followed by
*              EXPECTED RESULT
                                                                SPACE 2
...
*
         MACRO
         VRI_A &INST,&I2
.*                               &INST   - VRI-a instruction under test
.*                               &i2     - i2 mask field
...
X&TNUM   DS    0F
         ...
         VL    V22,V1FUDGE
         &INST V22,X'&I2'        test instruction  (dest is a source)
...
*   E744 VGBM   - Vector Generate Byte Mask
*
*        VRI-a instruction, I2 (immediate in HEX)
*              followed by
...
*---------------------------------------------------------------------
         VRI_A VGBM,0000
         DC    XL16'00000000 00000000 00000000 00000000' expected mask

         VRI_A VGBM,0001
         DC    XL16'00000000 00000000 00000000 000000FF' expected mask

         VRI_A VGBM,0002
         DC    XL16'00000000 00000000 00000000 0000FF00' expected mask

         VRI_A VGBM,0004
         DC    XL16'00000000 00000000 00000000 00FF0000' expected mask

         VRI_A VGBM,0008
         DC    XL16'00000000 00000000 00000000 FF000000' expected mask

         VRI_A VGBM,0010
         DC    XL16'00000000 00000000 000000FF 00000000' expected mask

         VRI_A VGBM,0020
         DC    XL16'00000000 00000000 0000FF00 00000000' expected mask

         VRI_A VGBM,0040
         DC    XL16'00000000 00000000 00FF0000 00000000' expected mask

         VRI_A VGBM,0080
         DC    XL16'00000000 00000000 FF000000 00000000' expected mask

         VRI_A VGBM,0100
         DC    XL16'00000000 000000FF 00000000 00000000' expected mask

         VRI_A VGBM,0200
         DC    XL16'00000000 0000FF00 00000000 00000000' expected mask

         VRI_A VGBM,0400
         DC    XL16'00000000 00FF0000 00000000 00000000' expected mask

         VRI_A VGBM,0800
         DC    XL16'00000000 FF000000 00000000 00000000' expected mask

         VRI_A VGBM,1000
         DC    XL16'000000FF 00000000 00000000 00000000' expected mask

         VRI_A VGBM,2000
         DC    XL16'0000FF00 00000000 00000000 00000000' expected mask

         VRI_A VGBM,4000
         DC    XL16'00FF0000 00000000 00000000 00000000' expected mask

         VRI_A VGBM,8000
         DC    XL16'FF000000 00000000 00000000 00000000' expected mask

         VRI_A VGBM,FFFF
         DC    XL16'FFFFFFFF FFFFFFFF FFFFFFFF FFFFFFFF' expected mask
                                                                EJECT
*---------------------------------------------------------------------
* case 1 - multiple bits
*---------------------------------------------------------------------
         VRI_A VGBM,8001
         DC    XL16'FF000000 00000000 00000000 000000FF' expected mask

         VRI_A VGBM,8181
         DC    XL16'FF000000 000000FF FF000000 000000FF' expected mask

         VRI_A VGBM,1818
         DC    XL16'000000FF FF000000 000000FF FF000000' expected mask

         VRI_A VGBM,0330
         DC    XL16'00000000 0000FFFF 0000FFFF 00000000' expected mask

         VRI_A VGBM,3003
         DC    XL16'0000FFFF 00000000 00000000 0000FFFF' expected mask

         VRI_A VGBM,3131
         DC    XL16'0000FFFF 000000FF 0000FFFF 000000FF' expected mask

         VRI_A VGBM,1313
         DC    XL16'000000FF 0000FFFF 000000FF 0000FFFF' expected mask

         VRI_A VGBM,0770
         DC    XL16'00000000 00FFFFFF 00FFFFFF 00000000' expected mask

         VRI_A VGBM,7007
         DC    XL16'00FFFFFF 00000000 00000000 00FFFFFF' expected mask

         VRI_A VGBM,7171
         DC    XL16'00FFFFFF 000000FF 00FFFFFF 000000FF' expected mask

         VRI_A VGBM,1717
         DC    XL16'000000FF 00FFFFFF 000000FF 00FFFFFF' expected mask
