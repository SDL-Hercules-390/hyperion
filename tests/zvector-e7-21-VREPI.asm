...
*  Vector Replicate Immediate instruction.
...
*
         LTR   R2,R2
         BZ    I2ZERO               is I2 zero
         BL    I2NEG                is I2 negative
         MVC   PRTSGN(1),=C'+'
         B     DOM4
...
*
DOM4     DS    0H
         LB    R2,M3                get m34 and convert
         CVD   R2,DECNUM
         MVC   PRT3,EDIT
         ED    PRT3,DECNUM
         MVC   PRTM3(2),PRT3+14     fill in message with m4 field
*
...
X&TNUM   DS    0F
         ...
         &INST V22,&I2,&M3    test instruction  (dest is a source)
...
*   E745 VREPI  - Vector Replicate Immediate
*
*        VRI_A  instruction, I2 (signed decinal), M3
*              followed by
