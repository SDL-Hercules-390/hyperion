...
*
***********************************************************************
*  This program tests proper functioning of the z/arch E6 VRR-i vector
*  convert to binary instructions. Exceptions are not tested.
*
...
***********************************************************************
*
*   *Testcase zvector-e6-11-convertbinary: VECTOR E6 VRR-i instruction
*   *
*   *   Zvector E6 tests for VRR-i encoded instruction:
*   *
*   *   E650 VCVB    - VECTOR CONVERT TO BINARY  (32)
*   *   E652 VCVBG   - VECTOR CONVERT TO BINARY  (64)
*   *
