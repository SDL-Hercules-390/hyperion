 TITLE 'zvector-e6-10-VLIP (Zvector E6 VRI-h)'
***********************************************************************
*
*        Zvector E6 instruction tests for VRI-h encoded:
*
...
*
***********************************************************************
*  This program tests proper functioning of the z/arch E6 VRI-h vector
*  load immediate decimal. Exceptions are not tested.
*
...
*    loadcore    "zvector-e6-10-VLIP.core" 0x0
...
*----------------------------------------------------------------------
*     VRI_H Macro to help build test tables
***********************************************************************
         MACRO
         VRI_H &INST,&I2,&I3
.*                               &INST  - VRS-d instruction under test
.*                               &I2    - 4 decimal immediate (2 bytes)
.*                               &I3    - bit 0   Sign Control
.*                                      - bit 1-3 Shift Amount
.*
.*
...
X&TNUM   DS    0F
         &INST V1,&I2,&I3        test instruction
...
*---------------------------------------------------------------------
* VLIP simple
         VRI_H VLIP,22102,2                 i2=x'5656' sc=0, shamt=2
         DC    XL16'0000000000000000000000000565600C'   V1

         VRI_H VLIP,22102,10                i2=x'5656' sc=1, shamt=2
         DC    XL16'0000000000000000000000000565600D'   V1

         VRI_H VLIP,22102,7                 i2=x'5656' sc=0, shamt=7
         DC    XL16'0000000000000000000056560000000C'   V1

         VRI_H VLIP,1,8                     i2=x'0001' sc=1, shamt=0
         DC    XL16'0000000000000000000000000000001D'   V1

         VRI_H VLIP,0,8                     i2=x'0001' sc=1, shamt=0
         DC    XL16'0000000000000000000000000000000D'   V1

         VRI_H VLIP,9,0                     i2=x'0009' sc=0, shamt=0
         DC    XL16'0000000000000000000000000000009C'   V1

         VRI_H VLIP,9,1                     i2=x'0009' sc=0, shamt=1
         DC    XL16'0000000000000000000000000000090C'   V1

         VRI_H VLIP,4660,0                  i2=x'1234' sc=0, shamt=0
         DC    XL16'0000000000000000000000000001234C'   V1

         VRI_H VLIP,4660,1                  i2=x'1234' sc=0, shamt=1
         DC    XL16'0000000000000000000000000012340C'   V1

         VRI_H VLIP,4660,2                  i2=x'1234' sc=0, shamt=2
         DC    XL16'0000000000000000000000000123400C'   V1

         VRI_H VLIP,4660,11                 i2=x'1234' sc=1, shamt=3
         DC    XL16'0000000000000000000000001234000D'   V1
