...
*   B969  CTZG  - COUNT TRAILING ZEROS
*
...
*  Instruction Extensions facility 4 RRE Count Leading Zeros and
*  Count Trailing Zeros instructions.
...
*    archlvl     z/Arch
*
*    loadcore    "$(testpath)/mie4-CLZG-CTZG.core" 0x0
*
...
XC&SYSNDX EQU *
         MEND
                                                                 EJECT
***********************************************************************
* (pending     B968  CLZG  - COUNT LEADING ZEROS
*  inclusion in SATK ASAM)
*
*     CLZG Macro to help build CLZG instruction
*        CLZG
*
...
***********************************************************************
         ...
         CLZG
                                                               SPACE 1
         DS    0H
         DC    XL4'B9680012'           CLZQ r1,r2
                                                               SPACE 1
         MEND

***********************************************************************
* (pending     B969  CTZG  - COUNT TRAILING ZEROS
*  inclusion in SATK ASAM)
*
*     CTZG Macro to help build CTZG instruction
*        CLZG
*
*        Note: R1, R2 are fixed registers:
*                         r1 = 1; r2 = 2
...
*        test routine will be here (from RRE macro)
*
*        followed by
*              EXPECTED RESULT
                                                                SPACE 2
...
*
         MACRO
         RRE   &INST
.*                               &INST   - RRE instruction under test
...
*
         ...
         DC    XL8'0AAA AAAA AAAA AAAA'   R2

         RRE   CLZG
         DC    XL8'0000 0000 0000 0006'   result
         DC    XL8'03AA AAAA AAAA AAAA'   R2

         RRE   CLZG
         DC    XL8'0000 0000 0000 0010'   result
         DC    XL8'0000 AAAA AAAA AAAA'   R2

         RRE   CLZG
         DC    XL8'0000 0000 0000 0018'   result
         DC    XL8'0000 00AA AAAA AAAA'   R2

         RRE   CLZG
         DC    XL8'0000 0000 0000 0030'   result
         DC    XL8'0000 0000 0000 AAAA'   R2

         RRE   CLZG
         DC    XL8'0000 0000 0000 0040'   result
...
*
         RRE   CTZG
         DC    XL8'0000 0000 0000 0000'   result
         DC    XL8'5555 5555 5555 5555'   R2

         RRE   CTZG
         DC    XL8'0000 0000 0000 0004'   result
         DC    XL8'0A55 5555 5555 5550'   R2

         RRE   CTZG
         DC    XL8'0000 0000 0000 0006'   result
         DC    XL8'0355 5555 5555 55C0'   R2

         RRE   CTZG
         DC    XL8'0000 0000 0000 0010'   result
         DC    XL8'0000 5555 5555 0000'   R2

         RRE   CTZG
         DC    XL8'0000 0000 0000 0018'   result
         DC    XL8'0000 00AA 5500 0000'   R2

         RRE   CTZG
         DC    XL8'0000 0000 0000 0030'   result
         DC    XL8'0555 0000 0000 0000'   R2
