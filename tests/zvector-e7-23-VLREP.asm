...
*
***********************************************************************
*  This program tests proper functioning of the z/arch E7 VRX
*  Vector Load and Replicate instruction.
*  Exceptions are not tested.
*
*  NOTE: As VLREP is missing, this test uses the Extended Mnemonics:
*        VREPLB, VREPLH, VLREPF, VLREPG
*
...
*
X&TNUM   DS    0F
         VL    v22,V1FUDGE       fudge v22
         LGF   R1,V2ADDR         load source address

         &INST V22,0(0,R1)   test instruction
...
*Byte
         ...
         DC    XL16'FFFFFFFFFFFFFFFF 0102030405060708'   source

         VRX   VLREPB,0
         DC    XL16'0101010101010101 0101010101010101'   result
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   source

         VRX   VLREPB,0
         DC    XL16'FEFEFEFEFEFEFEFE FEFEFEFEFEFEFEFE'   result
         DC    XL16'FEFDFCFBFAF9F8F7 090A0B0C0D0E0F00'   source

*Halfword
         VRX   VLREPH,1
         DC    XL16'FFAAFFAAFFAAFFAA FFAAFFAAFFAAFFAA'   result
         DC    XL16'FFAAFFFFFFFFFFFF 0102030405060708'   source

         VRX   VLREPH,1
         DC    XL16'0102010201020102 0102010201020102'   result
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   source

         VRX   VLREPH,1
         DC    XL16'07FD07FD07FD07FD 07FD07FD07FD07FD'   result
         DC    XL16'07FDFCFBFAF9F8F7 090A0B0C0D0E0F00'   source

*Word
         VRX   VLREPF,2
         DC    XL16'0102030401020304 0102030401020304'   result
         DC    XL16'0102030405060708 090A0B0C0D0E0F00'   source

         VRX   VLREPF,2
         DC    XL16'F9F8F704F9F8F704 F9F8F704F9F8F704'   result
         DC    XL16'F9F8F70405060708 FFFFFFFFFFFFFFFF'   source

         VRX   VLREPF,2
         DC    XL16'0808080708080807 0808080708080807'   result
         DC    XL16'08080807080807F7 FEFDFCFBFAF9F8F7'   source

*Doubleword
         VRX   VLREPG,3
         DC    XL16'FFFFFFFFFFFF09AA FFFFFFFFFFFF09AA'   result
         DC    XL16'FFFFFFFFFFFF09AA 0102030405060708'   source

         VRX   VLREPG,3
         DC    XL16'AABB112205060708 AABB112205060708'   result
         DC    XL16'AABB112205060708 090A0B0C0D0E0F00'   source

         VRX   VLREPG,3
         DC    XL16'FEFDFCFBFAF9F801 FEFDFCFBFAF9F801'   result
         DC    XL16'FEFDFCFBFAF9F801 090A0B0C0D0E0F00'   source
