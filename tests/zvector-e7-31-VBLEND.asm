...
XC&SYSNDX EQU *
         MEND
                                                                 EJECT
***********************************************************************
* (pending     E789 VBLEND - Vector Blend
*  inclusion in SATK ASAM)
*
*     VBLEND Macro to help build VBLEND instruction
*        VBLEND   m5
*
...
***********************************************************************
         MACRO
         VBLEND   &M5
.*                                     &M5  - m5 for VBLEND instruction
         LCLA  &V3M5
&V3M5    SETA  +(+X'30'+&M5)
                                                               SPACE 1
         DS    0H                      E789 VBLEND
         DC    X'E7'                   - Vector Blend
         DC    X'12'                    v1, v2
         DC    HL1'&V3M5'               v3, m5
         DC    x'00'                    reserved
         DC    x'40'                    v4, RXB
...
* Byte         m5 = 0
         ...
         VRR_D VBLEND,0
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'0000000000000000 0000000000000000'   v4

         VRR_D VBLEND,0
         DC    XL16'2222222222222222 2222222222222222'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v4

         VRR_D VBLEND,0
         DC    XL16'AA22AA22AA22AA22 AA22AA22AA22AA22'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'00FF00FF00FF00FF 00FF00FF00FF00FF'   v4

         VRR_D VBLEND,0
         DC    XL16'22AA22AA22AA22AA 22AA22AA22AA22AA'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'FF00FF00FF00FF00 FF00FF00FF00FF00'   v4

         VRR_D VBLEND,0
         DC    XL16'22AAAAAAAAAAAA22 22AAAAAAAAAAAA22'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'8000000000000080 8000000000000080'   v4

         VRR_D VBLEND,0
         DC    XL16'AAAAAAAAAAAA22AA AA22AAAAAAAAAAAA'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'0000000000008000 0080000000000000'   v4
...
* Halfword         m5 = 1
         ...
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   vA
         DC    XL16'0000000000000000 0000000000000000'   v4
         ...
         VRR_D VBLEND,1
         DC    XL16'2222AAAA2222AAAA 2222AAAA2222AAAA'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'FFFF0000FFFF0000 FFFF0000FFFF0000'   v4

         VRR_D VBLEND,1
         DC    XL16'AAAA2222AAAA2222 AAAA2222AAAA2222'   v3
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'0000FFFF0000FFFF 0000FFFF0000FFFF'   v4

         VRR_D VBLEND,1
         DC    XL16'2222AAAAAAAA2222 2222AAAAAAAA2222'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'8000000000008000 8000000000008000'   v4

         VRR_D VBLEND,1
         DC    XL16'AAAAAAAAAAAA2222 AAAA2222AAAAAAAA'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'0000000000008000 0000800000000000'   v4
...
* Word         m5 = 2
         ...
         VRR_D VBLEND,2
         DC    XL16'22222222AAAAAAAA AAAAAAAA22222222'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'FFFFFFFF00000000 00000000FFFFFFFF'   v4

         VRR_D VBLEND,2
         DC    XL16'AAAAAAAA22222222 22222222AAAAAAAA'   v3
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'00000000FFFFFFFF FFFFFFFF00000000'   v4

         VRR_D VBLEND,2
         DC    XL16'22222222AAAAAAAA AAAAAAAA22222222'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'8000000000000000 0000000080000000'   v4

         VRR_D VBLEND,2
         DC    XL16'AAAAAAAA22222222 22222222AAAAAAAA'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'0000000080000000 8000000000000000'   v4
...
* Doubleword   m5 = 3
         ...
         VRR_D VBLEND,3
         DC    XL16'AAAAAAAAAAAAAAAA 2222222222222222'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'0000000000000000 FFFFFFFFFFFFFFFF'   v4

         VRR_D VBLEND,3
         DC    XL16'2222222222222222 AAAAAAAAAAAAAAAA'   v3
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'FFFFFFFFFFFFFFFF 0000000000000000'   v4

         VRR_D VBLEND,3
         DC    XL16'AAAAAAAAAAAAAAAA 2222222222222222'   result
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'0000000000000000 8000000000000000'   v4
...
* Quadword     m5 = 4
         ...
         VRR_D VBLEND,4
         DC    XL16'2222222222222222 2222222222222222'   v3
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'FFFFFFFFFFFFFFFF 0000000000000000'   v4
         ...
         DC    XL16'2222222222222222 2222222222222222'   v2
         DC    XL16'AAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAA'   v3
         DC    XL16'8000000000000000 0000000000000000'   v4
