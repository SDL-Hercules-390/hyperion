...
*  Instruction Extensions facility 4 RRF-a Bit Depost and Bit Extract
*  instructions.
...
*    archlvl     z/Arch
*
*    loadcore    "$(testpath)/mie4-BDEPG-BDEPG.core" 0x0
*
...
XC&SYSNDX EQU *
         MEND
                                                                 EJECT
***********************************************************************
* (pending     B96C  BEXTG - Bit Extract
*  inclusion in SATK ASAM)
*
*     BEXTG Macro to help build BEXTG instruction
*        BEXTG
*
*        Note: R1, R2 are fixed registers:
*                         r1 = 1; r2 = 2; R3 = 3
***********************************************************************
         MACRO
       BEXTG
                                                               SPACE 1
         DS    0H
         DC    XL4'B96C3012'           BEXTG r1,r2,R3
                                                               SPACE 1
         MEND

***********************************************************************
* (pending     B96D  BDEPG - Bit Deposit
*  inclusion in SATK ASAM)
*
*     BDEPG Macro to help build BDEPG instruction
*        BDEPG
*
*        Note: R1, R2 are fixed registers:
*                         r1 = 1; r2 = 2; R3 = 3
***********************************************************************
         ...
         BDEPG
                                                               SPACE 1
         DS    0H
         DC    XL4'B96D3012'           BDEPG r1,r2,R3
                                                               SPACE 1
         MEND
                                                                EJECT
***********************************************************************
...
R2ADDR   DC    A(0)           address of R2 source
R3ADDR   DC    A(0)           address of R3 source
...
*        test routine will be here (from RRF-a macro)
*
*        followed by
*              EXPECTED RESULT
                                                                SPACE 2
...
*
         MACRO
         RRF_A   &INST
.*                               &INST   - RRF_A instruction under test
...
X&TNUM   DS    0F
         ...
         XGR   R2,R2
         L     R2,R2ADDR         load r2 source address
         LG    R2,0(R2)          load source

         XGR   R3,R3
         L     R3,R3ADDR         load r3 source address
         LG    R3,0(R3)          load source
...
*
         ...
         RRF_A BEXTG
         DC    XL8'0000 0000 0000 0000'   result
         DC    XL8'AAAA AAAA AAAA AAAA'   R2
         DC    XL8'0000 0000 0000 0000'   R3

         RRF_A BEXTG
         DC    XL8'0000 0000 0000 0000'   result
         DC    XL8'0000 0000 0000 0000'   R2
         DC    XL8'AAAA AAAA AAAA AAAA'   R3

         RRF_A BEXTG
         DC    XL8'B800 0000 0000 0000'   result
         DC    XL8'0008 9000 000A B000'   R2
         DC    XL8'0008 0001 000A 8000'   R3

         RRF_A BEXTG
         DC    XL8'9A00 0000 0000 0000'   result
         DC    XL8'0008 9000 000A B000'   R2
         DC    XL8'0008 000C 000A 6006'   R3

         RRF_A BEXTG
         DC    XL8'9B00 0000 0000 0000'   result
         DC    XL8'0008 9000 000A B004'   R2
         DC    XL8'0008 000C 000A 6006'   R3

         RRF_A BEXTG
         DC    XL8'9B80 0000 0000 0000'   result
         DC    XL8'0008 9000 000A B006'   R2
         DC    XL8'0008 000C 000A 6006'   R3

         RRF_A BEXTG
         DC    XL8'89AB 0000 0000 0000'   result
         DC    XL8'0008 9000 000A B000'   R2
         DC    XL8'000F F000 000F F000'   R3

         RRF_A BEXTG
         DC    XL8'FFFF 0000 0000 0000'   result
         DC    XL8'000F F000 000F F000'   R2
         DC    XL8'000F F000 000F F000'   R3

         RRF_A BEXTG
         DC    XL8'0000 0000 0000 0000'   result
         DC    XL8'0000 0000 0000 0000'   R2
         DC    XL8'FFFF FFFF FFFF FFFF'   R3

         RRF_A BEXTG
         DC    XL8'1000 1000 1000 0001'   result
         DC    XL8'1000 1000 1000 0001'   R2
         DC    XL8'FFFF FFFF FFFF FFFF'   R3
...
*
         ...
         RRF_A BDEPG
         DC    XL8'0008 0000 000A 8000'   result
         DC    XL8'B800 0000 0000 0000'   R2
         DC    XL8'0008 0001 000A 8000'   R3

         RRF_A BDEPG
         DC    XL8'0008 0000 000A 2000'   result
         DC    XL8'9A00 0000 0000 0000'   R2
         DC    XL8'0008 000C 000A 6006'   R3

         RRF_A BDEPG
         DC    XL8'0008 0000 000A 2004'   result
         DC    XL8'9B00 0000 0000 0000'   R2
         DC    XL8'0008 000C 000A 6006'   R3

         RRF_A BDEPG
         DC    XL8'0008 0000 000A 2006'   result
         DC    XL8'9B80 0000 0000 0000'   R2
         DC    XL8'0008 000C 000A 6006'   R3

         RRF_A BDEPG
         DC    XL8'0008 9000 000A B000'   result
         DC    XL8'89AB 0000 0000 0000'   R2
         DC    XL8'000F F000 000F F000'   R3

         RRF_A BDEPG
         DC    XL8'000F F000 000F F000'   result
         DC    XL8'FFFF 0000 0000 0000'   R2
         DC    XL8'000F F000 000F F000'   R3
         ...
         RRF_A BDEPG
         DC    XL8'0001 0001 0001 0001'   result
         DC    XL8'0001 0001 0001 0001'   R2
         DC    XL8'FFFF FFFF FFFF FFFF'   R3
