 TITLE 'zvector-e7-32-VGEM'
***********************************************************************
*
*   Zvector E7 instruction tests for VRR-a encoded:
*
*   E754 VGEM   - Vector Generate Element Masks
*
...
*  Vector Generate Element Masks instruction.
...
*    archlvl     z/Arch
*
*    loadcore    "$(testpath)/zvector-e7-32-VGEM.core" 0x0
*
...
XC&SYSNDX EQU *
         MEND
                                                                 EJECT
***********************************************************************
* (pending     E754 VGEM   - Vector Generate Element Masks
*  inclusion in SATK ASAM)
*
*     VGEM Macro to help build VGEM instruction
*        VGEM   m3
*
*        Note: v1, v2 are fixed vector registers:
*                         v1 = 1; v2 = 2
***********************************************************************
         MACRO
         VGEM  &M3
.*                                     &M3  - m3 for VGEM instruction
         LCLA  &M3RXB
&M3RXB   SETA  +(&M3*16)
                                                               SPACE 1
         DS    0H                      E754 VGEM
         DC    X'E7'                   - Vector Generate Element Masks
         DC    X'12'                    v1, v2
         DC    x'0000'                  reserved
         DC    HL1'&M3RXB'              M3, RXB
         DC    X'54'
...
* Byte   M3 = 0
         ...
         VRR_A VGEM,0
         DC    XL16'0000000000000000 0000000000000000'   result
         DC    XL16'0000FFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 00000000000000FF'   result
         DC    XL16'0001000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 000000000000FF00'   result
         DC    XL16'0002000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 000000000000FFFF'   result
         DC    XL16'0003000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 0000000000FF0000'   result
         DC    XL16'0004000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 0000000000FF00FF'   result
         DC    XL16'0005000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 0000000000FFFF00'   result
         DC    XL16'0006000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 0000000000FFFFFF'   result
         DC    XL16'0007000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 00000000FF000000'   result
         DC    XL16'0008000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 00000000FF0000FF'   result
         DC    XL16'0009000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 00000000FF00FF00'   result
         DC    XL16'000A000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 00000000FF00FFFF'   result
         DC    XL16'000B000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 00000000FFFF0000'   result
         DC    XL16'000C000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 00000000FFFF00FF'   result
         DC    XL16'000D000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 00000000FFFFFF00'   result
         DC    XL16'000E000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 00000000FFFFFFFF'   result
         DC    XL16'000F000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 000000FF00000000'   result
         DC    XL16'0010000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 0000FF0000000000'   result
         DC    XL16'0020000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 00FF000000000000'   result
         DC    XL16'0040000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000000000 FF00000000000000'   result
         DC    XL16'0080000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'00000000000000FF 0000000000000000'   result
         DC    XL16'0100000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'000000000000FF00 0000000000000000'   result
         DC    XL16'0200000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000000000FF0000 0000000000000000'   result
         DC    XL16'0400000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'00000000FF000000 0000000000000000'   result
         DC    XL16'0800000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'000000FF00000000 0000000000000000'   result
         DC    XL16'1000000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'0000FF0000000000 0000000000000000'   result
         DC    XL16'2000000000000000 0000000000000000'   v2

         VRR_A VGEM,0
         DC    XL16'00FF000000000000 0000000000000000'   result
         DC    XL16'4000000000000000 0000000000000000'   v2
         ...
         DC    XL16'FFFF000000000000 0000000000000000'   v2
...
* Halfword     M3 = 1
         ...
         VRR_A VGEM,1
         DC    XL16'0000000000000000 0000000000000000'   result
         DC    XL16'00FFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         ...
         VRR_A VGEM,1
         DC    XL16'0000000000000000 00000000FFFFFFFF'   result
         DC    XL16'0300000000000000 0000000000000000'   v2

         VRR_A VGEM,1
         DC    XL16'0000000000000000 0000FFFF00000000'   result
         DC    XL16'0400000000000000 0000000000000000'   v2

         VRR_A VGEM,1
         DC    XL16'0000000000000000 0000FFFF0000FFFF'   result
         DC    XL16'0500000000000000 0000000000000000'   v2

         VRR_A VGEM,1
         DC    XL16'0000000000000000 0000FFFFFFFF0000'   result
         DC    XL16'0600000000000000 0000000000000000'   v2

         VRR_A VGEM,1
         DC    XL16'0000000000000000 0000FFFFFFFFFFFF'   result
         DC    XL16'0700000000000000 0000000000000000'   v2

         VRR_A VGEM,1
         DC    XL16'0000000000000000 FFFF000000000000'   result
         DC    XL16'0800000000000000 0000000000000000'   v2

         VRR_A VGEM,1
         DC    XL16'000000000000FFFF 0000000000000000'   result
         DC    XL16'1000000000000000 0000000000000000'   v2

         VRR_A VGEM,1
         DC    XL16'00000000FFFF0000 0000000000000000'   result
         DC    XL16'2000000000000000 0000000000000000'   v2
         ...
         VRR_A VGEM,1
         DC    XL16'FFFF000000000000 0000000000000000'   result
         DC    XL16'8000000000000000 0000000000000000'   v2

         VRR_A VGEM,1
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   result
         DC    XL16'FF00000000000000 0000000000000000'   v2
...
* Word         M3 = 2
         ...
         VRR_A VGEM,2
         DC    XL16'0000000000000000 0000000000000000'   result
         DC    XL16'0FFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         ...
         DC    XL16'3000000000000000 0000000000000000'   v2

         VRR_A VGEM,2
         DC    XL16'00000000FFFFFFFF 0000000000000000'   result
         DC    XL16'4000000000000000 0000000000000000'   v2

         VRR_A VGEM,2
         DC    XL16'00000000FFFFFFFF 00000000FFFFFFFF'   result
         DC    XL16'5000000000000000 0000000000000000'   v2

         VRR_A VGEM,2
         DC    XL16'00000000FFFFFFFF FFFFFFFF00000000'   result
         DC    XL16'6000000000000000 0000000000000000'   v2

         VRR_A VGEM,2
         DC    XL16'00000000FFFFFFFF FFFFFFFFFFFFFFFF'   result
         DC    XL16'7000000000000000 0000000000000000'   v2

         VRR_A VGEM,2
         DC    XL16'FFFFFFFF00000000 0000000000000000'   result
         DC    XL16'8000000000000000 0000000000000000'   v2

         VRR_A VGEM,2
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   result
         DC    XL16'F000000000000000 0000000000000000'   v2
...
* Doubleword        M3 = 3
         ...
         VRR_A VGEM,3
         DC    XL16'0000000000000000 0000000000000000'   result
         DC    XL16'3FFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         ...
         VRR_A VGEM,3
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   result
         DC    XL16'C000000000000000 0000000000000000'   v2
