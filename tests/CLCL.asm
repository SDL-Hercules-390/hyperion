 TITLE '                                 CLCL Unaligned Buffers Test'
***********************************************************************
*
*                     CLCL Unaligned Buffers Test
*
***********************************************************************
*
...
***********************************************************************
         ...
         ASAIPL   IA=BEGIN
                                                                SPACE 2
***********************************************************************
*               The actual "CLCL" program itself...
***********************************************************************
*
...
*                 Compare the two buffers...
                                                                SPACE
CONTINUE CLCL  R0,R14           Compare BUFFER1 with BUFFER2...
...
*           Inequality found: VERIFY ITS ACCURACY!
         ...
         BE    FAILURE          Bogus inequality!  CLCL BUG!  FAIL!
                                                                SPACE
*           CLCL was correct.  Get past inequality
...
BUFF2OFF EQU   X'A68'
                                                                SPACE
         ORG   CLCL+(1*(128*1024))+BUFF1OFF
BUFFER1  DC    (BUFFSIZE/8)XL8'00'
                                                                SPACE
         ORG   CLCL+(2*(128*1024))+BUFF2OFF
BUFFER2  DC    (BUFFSIZE/8)XL8'00'
                                                                SPACE
         ORG   CLCL+(3*(128*1024))    X'60000'
DATA1    DC    (DATASIZE)X'00'        X'60000'
                                                                SPACE
         ORG   CLCL+(4*(128*1024))    X'80000'
