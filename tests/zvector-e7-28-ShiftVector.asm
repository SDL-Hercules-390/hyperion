 TITLE 'zvector-e7-28-ShiftVector'
***********************************************************************
*
...
*  element shift left, shift right logical, shitft right arithmetic
*  instructions where the shift is a vector element.
*
...
***********************************************************************
*
*   *Testcase zzvector-e7-28-ShiftVector
*   *
*   *   Zvector E7 instruction tests for VRR-c encoded:
*   *
*   *   E770 VESLV  - Vector Element Shift Left Vector
...
*
*---------------------------------------------------------------------
*   VESLV  - Vector Element Shift Left Vector
*---------------------------------------------------------------------
*Byte
         VRR_C VESLV,0
         DC    XL16'0102040810204080 0102040810204080'   result
         DC    XL16'0101010101010101 0101010101010101'   v2
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   v3

         VRR_C VESLV,0
         DC    XL16'FFFEFCF8F0E0C080 FFFEFCF8F0E0C080'   result
...
*Halfword
         VRR_C VESLV,1
         DC    XL16'0001000200040008 0010002000400080'   result
         DC    XL16'0001000100010001 0001000100010001'   v2
         DC    XL16'0000000100020003 0004000500060007'   v3

         VRR_C VESLV,1
         DC    XL16'0100020004000800 1000200040008000'   result
         DC    XL16'0001000100010001 0001000100010001'   v2
         DC    XL16'00080009000A000B 000C000D000E000F'   v3

         VRR_C VESLV,1
         DC    XL16'FFFFFFFEFFFCFFF8 FFF0FFE0FFC0FF80'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0000000100020003 0004000500060007'   v3

         VRR_C VESLV,1
         DC    XL16'FF00FE00FC00F800 F000E000C0008000'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'00080009000A000B 000C000D000E000F'   v3
         ...
         DC    XL16'0001000200040008 0010002000400080'   result
         DC    XL16'0001000100010001 0001000100010001'   v2
         DC    XL16'F000F001F002F003 F004F005F006F007'   v3
...
*Word
         VRR_C VESLV,2
         DC    XL16'0000000100000002 0000000400000008'   result
         DC    XL16'0000000100000001 0000000100000001'   v2
         DC    XL16'0000000000000001 0000000200000003'   v3

         VRR_C VESLV,2
         DC    XL16'0000010000000200 0000040000000800'   result
         DC    XL16'0000000100000001 0000000100000001'   v2
         DC    XL16'0000000800000009 0000000A0000000B'   v3

         VRR_C VESLV,2
         DC    XL16'FFFFFFFFFFFFFFFE FFFFFFFCFFFFFFF8'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0000000000000001 0000000200000003'   v3

         VRR_C VESLV,2
         DC    XL16'FFFFFF00FFFFFE00 FFFFFC00FFFFF800'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0000000800000009 0000000A0000000B'   v3
         ...
         DC    XL16'0000000100000002 0000000400000008'   result
         DC    XL16'0000000100000001 0000000100000001'   v2
         DC    XL16'F0000000F0000001 F0000002F0000003'   v3

         VRR_C VESLV,2
         DC    XL16'FFFFFF00FFFFFE00 FFFFFC00FFFFF800'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'F0000008F0000009 F000000AF000000B'   v3

*Doubleword
         VRR_C VESLV,3
         DC    XL16'0000000000000001 0000000000000002'   result
         DC    XL16'0000000000000001 0000000000000001'   v2
         DC    XL16'0000000000000000 0000000000000001'   v3

         VRR_C VESLV,3
         DC    XL16'0000000000000400 0000000000000800'   result
         DC    XL16'0000000000000001 0000000000000001'   v2
         DC    XL16'000000000000000A 000000000000000B'   v3

         VRR_C VESLV,3
         DC    XL16'0000040000000000 0800000000000000'   result
         DC    XL16'0000000000000001 0000000000000001'   v2
         DC    XL16'000000000000002A 000000000000003B'   v3

         VRR_C VESLV,3
         DC    XL16'FFFFFFFFFFFFFF80 FFFFFFFFFFFC0000'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0000000000000007 0000000000000012'   v3

         VRR_C VESLV,3
         DC    XL16'FFFFFFFC00000000 FFF8000000000000'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0000000000000022 0000000000000033'   v3


         VRR_C VESLV,3
         DC    XL16'0000000000000400 0000000000000800'   result
         DC    XL16'0000000000000001 0000000000000001'   v2
         DC    XL16'F00000000000000A F00000000000000B'   v3

         VRR_C VESLV,3
         DC    XL16'FFFFFFFC00000000 FFF8000000000000'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'F000000000000022 F000000000000033'   v3

                                                                EJECT
*---------------------------------------------------------------------
*   VESRLV - Vector Element Shift Right Logical Vector
*---------------------------------------------------------------------
*Byte
         VRR_C VESRLV,0
         DC    XL16'8040201008040201 8040201008040201'   result
         DC    XL16'8080808080808080 8080808080808080'   v2
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   v3

         VRR_C VESRLV,0
         DC    XL16'FF7F3F1F0F070301 FF7F3F1F0F070301'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   v3
...
*Halfword
         VRR_C VESRLV,1
         DC    XL16'8000400020001000 0800040002000100'   result
         DC    XL16'8000800080008000 8000800080008000'   v2
         DC    XL16'0000000100020003 0004000500060007'   v3

         VRR_C VESRLV,1
         DC    XL16'0080004000200010 0008000400020001'   result
         DC    XL16'8000800080008000 8000800080008000'   v2
         DC    XL16'00080009000A000B 000C000D000E000F'   v3

         VRR_C VESRLV,1
         DC    XL16'FFFF7FFF3FFF1FFF 0FFF07FF03FF01FF'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0000000100020003 0004000500060007'   v3

         VRR_C VESRLV,1
         DC    XL16'00FF007F003F001F 000F000700030001'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'00080009000A000B 000C000D000E000F'   v3
...
*Word
         VRR_C VESRLV,2
         DC    XL16'8000000040000000 2000000010000000'   result
         DC    XL16'8000000080000000 8000000080000000'   v2
         DC    XL16'0000000000000001 0000000200000003'   v3

         VRR_C VESRLV,2
         DC    XL16'0080000000400000 0020000000100000'   result
         DC    XL16'8000000080000000 8000000080000000'   v2
         DC    XL16'0000000800000009 0000000A0000000B'   v3

         VRR_C VESRLV,2
         DC    XL16'FFFFFFFF7FFFFFFF 3FFFFFFF1FFFFFFF'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0000000000000001 0000000200000003'   v3

         VRR_C VESRLV,2
         DC    XL16'00FFFFFF007FFFFF 003FFFFF001FFFFF'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0000000800000009 0000000A0000000B'   v3
...
*Doubleword
         VRR_C VESRLV,3
         DC    XL16'8000000000000000 4000000000000000'   result
         DC    XL16'8000000000000000 8000000000000000'   v2
         DC    XL16'0000000000000000 0000000000000001'   v3

         VRR_C VESRLV,3
         DC    XL16'0020000000000000 0010000000000000'   result
         DC    XL16'8000000000000000 8000000000000000'   v2
         DC    XL16'000000000000000A 000000000000000B'   v3

         VRR_C VESRLV,3
         DC    XL16'0000000000200000 0000000000000010'   result
         DC    XL16'8000000000000000 8000000000000000'   v2
         DC    XL16'000000000000002A 000000000000003B'   v3

         VRR_C VESRLV,3
         DC    XL16'01FFFFFFFFFFFFFF 00003FFFFFFFFFFF'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0000000000000007 0000000000000012'   v3

         VRR_C VESRLV,3
         DC    XL16'000000003FFFFFFF 0000000000001FFF'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0000000000000022 0000000000000033'   v3
         ...
         DC    XL16'F000000000000022 F000000000000033'   v3
                                                               ...
                                                               EJECT
*---------------------------------------------------------------------
*   VESRAV - Vector Element Shift Right Arithmetic Vector
*---------------------------------------------------------------------
*Byte
         VRR_C VESRAV,0
         DC    XL16'4020100804020100 4020100804020100'   result
         DC    XL16'4040404040404040 4040404040404040'   v2
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   v3

         VRR_C VESRAV,0
         DC    XL16'80C0E0F0F8FCFEFF 80C0E0F0F8FCFEFF'   result
         DC    XL16'8080808080808080 8080808080808080'   v2
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   v3

         VRR_C VESRAV,0
         DC    XL16'F0F8FCFEFFFFFFFF F8FCFEFFFFFFFFFF'   result
         DC    XL16'F0F1F2F3F4F5F6F7 F8F9FAFBFCFDFEFF'   v2
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   v3
...
*Halfword
         VRR_C VESRAV,1
         DC    XL16'4000200010000800 0400020001000080'   result
         DC    XL16'4000400040004000 4000400040004000'   v2
         DC    XL16'0000000100020003 0004000500060007'   v3

         VRR_C VESRAV,1
         DC    XL16'8000C000E000F000 F800FC00FE00FF00'   result
         DC    XL16'8000800080008000 8000800080008000'   v2
         DC    XL16'0000000100020003 0004000500060007'   v3

         VRR_C VESRAV,1
         DC    XL16'FF80FFC0FFE0FFF0 FFF8FFFCFFFEFFFF'   result
         DC    XL16'8000800080008000 8000800080008000'   v2
         DC    XL16'00080009000A000B 000C000D000E000F'   v3

         VRR_C VESRAV,1
         DC    XL16'F0F1F979FD3DFEDE FF8FFFD7FFF3FFFD'   result
         DC    XL16'F0F1F2F3F4F5F6F7 F8F9FAFBFCFDFEFF'   v2
         DC    XL16'0000000100020003 0004000500060007'   v3

         VRR_C VESRAV,1
         DC    XL16'FFF0FFF9FFFDFFFE FFFFFFFFFFFFFFFF'   result
         DC    XL16'F0F1F2F3F4F5F6F7 F8F9FAFBFCFDFEFF'   v2
         DC    XL16'00080009000A000B 000C000D000E000F'   v3
...
*Word
         VRR_C VESRAV,2
         DC    XL16'4000000020000000 1000000008000000'   result
         DC    XL16'4000000040000000 4000000040000000'   v2
         DC    XL16'0000000000000001 0000000200000003'   v3

         VRR_C VESRAV,2
         DC    XL16'80000000C0000000 E0000000F0000000'   result
         DC    XL16'8000000080000000 8000000080000000'   v2
         DC    XL16'0000000000000001 0000000200000003'   v3

         VRR_C VESRAV,2
         DC    XL16'FF800000FFC00000 FFE00000FFF00000'   result
         DC    XL16'8000000080000000 8000000080000000'   v2
         DC    XL16'0000000800000009 0000000A0000000B'   v3

         VRR_C VESRAV,2
         DC    XL16'F0F1F2F3FA7AFB7B FE3E7EBEFF9FBFDF'   result
         DC    XL16'F0F1F2F3F4F5F6F7 F8F9FAFBFCFDFEFF'   v2
         DC    XL16'0000000000000001 0000000200000003'   v3

         VRR_C VESRAV,2
         DC    XL16'FFF0F1F2FFFA7AFB FFFE3E7EFFFF9FBF'   result
         DC    XL16'F0F1F2F3F4F5F6F7 F8F9FAFBFCFDFEFF'   v2
         DC    XL16'0000000800000009 0000000A0000000B'   v3
...
*Doubleword
         VRR_C VESRAV,3
         DC    XL16'4000000000000000 2000000000000000'   result
         DC    XL16'4000000000000000 4000000000000000'   v2
         DC    XL16'0000000000000000 0000000000000001'   v3

         VRR_C VESRAV,3
         DC    XL16'8000000000000000 C000000000000000'   result
         DC    XL16'8000000000000000 8000000000000000'   v2
         DC    XL16'0000000000000000 0000000000000001'   v3

         VRR_C VESRAV,3
         DC    XL16'FFE0000000000000 FFF0000000000000'   result
         DC    XL16'8000000000000000 8000000000000000'   v2
         DC    XL16'000000000000000A 000000000000000B'   v3

         VRR_C VESRAV,3
         DC    XL16'FFFFFFFFFFE00000 FFFFFFFFFFFFFFF0'   result
         DC    XL16'8000000000000000 8000000000000000'   v2
         DC    XL16'000000000000002A 000000000000003B'   v3

         VRR_C VESRAV,3
         DC    XL16'FFE1E3E5E7E9EBED FFFFFE3E7EBEFF3F'   result
         DC    XL16'F0F1F2F3F4F5F6F7 F8F9FAFBFCFDFEFF'   v2
         DC    XL16'0000000000000007 0000000000000012'   v3

         VRR_C VESRAV,3
         DC    XL16'FFFFFFFFFC3C7CBC FFFFFFFFFFFFFF1F'   result
         DC    XL16'F0F1F2F3F4F5F6F7 F8F9FAFBFCFDFEFF'   v2
         DC    XL16'0000000000000022 0000000000000033'   v3
