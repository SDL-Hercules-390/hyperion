 TITLE 'zvector-e6-17-VSCHP (Zvector E6 VRR-b)'
***********************************************************************
*
...
*  scale and convert to HFP instruction. Exceptions are not tested.
*
...
*  HFP. This result is compared to VSCHP result. An XCHECK test
...
XCHECK   EQU   *
         ...
         NILL  r1,1           RM : bit 3
         LTR   R1,R1
         BNZ   0(R15)         not zero RM, ignore test
...
*
* convert R0 to appropriate HFP format
* m4: 2-> short, 3->long, 4->extended
*
         XGR   R1,R1
         IC    R1,M4       get hfp format
         C     R1,=F'2'
         BE    XCSHORT
         C     R1,=F'3'
         BE    XCLONG
...
* hfp - long
XCLONG   DS    0F
         CDGR  FPR4,R0     convert r0 to long hfp
         VST   V4,XCRESULT
         B     XC001

* hfp - extended
XCEXT    DS    0F
         CXGR  FPR4,R0     convert r0 to extended hfp: FPR4 & FPR6
         VSTEG V4,XCRESULT,0        save high order extended hfp
         VSTEG V6,XCRESULT+8,0      save low order extended hfp
...
X&TNUM   DS    0F
         ...
         &INST V1,V2,V3,&M4,&M5    test instruction
...
* +9000000000000001
         VRR_B VSCHP,2,0,0
         DC    XL16'4E1FF973000000000000000000000000'
...
*  9223372036854775807
         VRR_B VSCHP,2,0,0
         DC    XL16'507FFFFF000000000000000000000000'
         DC    XL16'0000000000009223372036854775807C'

* 18446744073709551615
         VRR_B VSCHP,2,0,0
         DC    XL16'50FFFFFF000000000000000000000000'
...
* +9000000000000001
         VRR_B VSCHP,3,0,0
         DC    XL16'4E1FF973CAFA80010000000000000000'
         DC    XL16'0000000000000009000000000000001C'
...
*  9223372036854775807
         VRR_B VSCHP,3,0,0
         DC    XL16'507FFFFFFFFFFFFF0000000000000000'
         DC    XL16'0000000000009223372036854775807C'

* 18446744073709551615
         VRR_B VSCHP,3,0,0
         DC    XL16'50FFFFFFFFFFFFFF0000000000000000'
         DC    XL16'0000000000018446744073709551615C'
...
* +9000000000000001
         VRR_B VSCHP,2,0,2
         DC    XL16'4FC7D713000000000000000000000000'
         DC    XL16'0000000000000009000000000000001C'
...
*  9223372036854775807
         VRR_B VSCHP,2,0,2
         DC    XL16'5231FFFF000000000000000000000000'
         DC    XL16'0000000000009223372036854775807C'

* 18446744073709551615
         VRR_B VSCHP,2,0,2
         DC    XL16'5263FFFF000000000000000000000000'
         DC    XL16'0000000000018446744073709551615C'
...
* +9000000000000001
         VRR_B VSCHP,3,0,1
         DC    XL16'4F13FBE85EDC90000000000000000000'
         DC    XL16'0000000000000009000000000000001C'
...
*  9223372036854775807
         VRR_B VSCHP,3,0,2
         DC    XL16'5231FFFFFFFFFFFF0000000000000000'
         DC    XL16'0000000000009223372036854775807C'

* 18446744073709551615
         VRR_B VSCHP,3,0,2
         DC    XL16'5263FFFFFFFFFFFF0000000000000000'
         DC    XL16'0000000000018446744073709551615C'
...
* +1
         VRR_B VSCHP,4,0,1
         DC    XL16'41A00000000000003300000000000000'
         DC    XL16'0000000000000000000000000000001C'
* -1
         VRR_B VSCHP,4,0,1
         DC    XL16'C1A0000000000000B300000000000000'
         DC    XL16'0000000000000000000000000000001D'

* +9000000000000001
         VRR_B VSCHP,4,0,2
         DC    XL16'4FC7D713B49DA0064140000000000000'
         DC    XL16'0000000000000009000000000000001C'

* -9223372036854775808
         VRR_B VSCHP,4,0,2
         DC    XL16'D232000000000000C400000000000000'
         DC    XL16'0000000000009223372036854775808D'

*  9223372036854775807
         VRR_B VSCHP,4,0,2
         DC    XL16'5231FFFFFFFFFFFF44FF9C0000000000'
         DC    XL16'0000000000009223372036854775807C'

* 18446744073709551615
         VRR_B VSCHP,4,0,2
         DC    XL16'5263FFFFFFFFFFFF44FF9C0000000000'
         DC    XL16'0000000000018446744073709551615C'
...
* +9000000000000001
         VRR_B VSCHP,2,1,0
         DC    XL16'4E1FF974000000000000000000000000'
         DC    XL16'0000000000000009000000000000001C'
...
*  9223372036854775807
         VRR_B VSCHP,2,1,0
         DC    XL16'50800000000000000000000000000000'
         DC    XL16'0000000000009223372036854775807C'

* 18446744073709551615
         VRR_B VSCHP,2,1,0
         DC    XL16'51100000000000000000000000000000'
         DC    XL16'0000000000018446744073709551615C'
...
* 9009000000018446744073709551615
         VRR_B VSCHP,3,1,0
         DC    XL16'5A71B5A6237518710000000000000000'
         DC    XL16'9009000000018446744073709551615C'

* 9999999990018446744073709551615
         VRR_B VSCHP,3,1,0
         DC    XL16'5A7E37BE1E05A6B10000000000000000'
...
* +9000000000000001
         VRR_B VSCHP,2,1,2
         DC    XL16'4FC7D714000000000000000000000000'
         DC    XL16'0000000000000009000000000000001C'
...
*  9223372036854775807
         VRR_B VSCHP,2,1,2
         DC    XL16'52320000000000000000000000000000'
         DC    XL16'0000000000009223372036854775807C'

* 18446744073709551615
         VRR_B VSCHP,2,1,2
         DC    XL16'52640000000000000000000000000000'
         DC    XL16'0000000000018446744073709551615C'
...
* +9000000000000001
         VRR_B VSCHP,3,1,2
         DC    XL16'4FC7D713B49DA0060000000000000000'
         DC    XL16'0000000000000009000000000000001C'
...
* 9009000000018446744073709551615
         VRR_B VSCHP,3,1,3
         DC    XL16'5D1BC2D90FA816780000000000000000'
         DC    XL16'9009000000018446744073709551615C'

* 9999999990018446744073709551615
         VRR_B VSCHP,3,1,3
         DC    XL16'5D1ED09BEA5461320000000000000000'
         DC    XL16'9999999990018446744073709551615C'
*----------------------------------------------------------------------
* extended float
*----------------------------------------------------------------------
...
* 9009000000018446744073709551615
         VRR_B VSCHP,4,1,3
         DC    XL16'5D1BC2D90FA816774F8E890963FFFFC2'
         DC    XL16'9009000000018446744073709551615C'

* 9999999990018446744073709551615
         VRR_B VSCHP,4,1,3
         DC    XL16'5D1ED09BEA5461324F1798D1BB5FFFC2'
         DC    XL16'9999999990018446744073709551615C'
