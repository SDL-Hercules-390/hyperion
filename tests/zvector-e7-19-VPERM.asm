...
*
***********************************************************************
*  This program tests proper functioning of the z/arch E7 VRR-e
...
*        test routine will be here (from VRR-e macro)
*
*        followed by
*              EXPECTED RESULT
                                                                SPACE 2
...
*
         MACRO
         VRR_E &INST
.*                               &INST   - VRR-e instruction under test
.*                                         no m fields
...
X&TNUM   DS    0F
         ...
         LGF   R1,V4ADDR         load v3 source
         VL    v24,0(R1)         use v23 to test decoder

         &INST V22,V22,V23,v24   test instruction (dest is a source)
...
*---------------------------------------------------------------------
         ...
         VRR_E VPERM
         DC    XL16'00FFFFFFFFFFFFFF FFFFFFFFFFFFFF00'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0000000000000000 0000000000000000'   v3
         DC    XL16'1001020304050607 08090A0B0C0D0E1F'   v4

         VRR_E VPERM
         DC    XL16'00FFFFFFFFFFFF00 00FFFFFFFFFFFF00'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0000000000000000 0000000000000000'   v3
         DC    XL16'1001020304050617 18090A0B0C0D0E1F'   v4

         VRR_E VPERM
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   result
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   v2
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v3
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   v4

         VRR_E VPERM
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   v3
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   v4

         VRR_E VPERM
         DC    XL16'FFFFFF00FFFFFF00 FFFFFF00FFFFFFFF'   result
         DC    XL16'FFFFFF00FFFFFF00 FFFFFF00FFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   v3
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   v4

         VRR_E VPERM
         DC    XL16'1122334455667788 718191A1B0B1B2B3'   result
         DC    XL16'1122334455667788 99AABBCCDDEEFF00'   v2
         DC    XL16'020F1F2031415161 718191A1B0B1B2B3'   v3
         DC    XL16'0001020304050607 18191A1B1C1D1E1F'   v4

         VRR_E VPERM
         DC    XL16'7060504030201000 FFFFFFFFFFFFFFFF'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'7060504030201000 F0E0D0C0B0A09080'   v3
         DC    XL16'1011121314151617 08090A0B0C0D0E0F'   v4

         VRR_E VPERM
         DC    XL16'FFFFFFFFFFFFFFFF FF0506FFFF0706FF'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0101FF0202FF0304 FF0506FFFF0706FF'   v3
         DC    XL16'2021222324252627 38393A3B3C3D3E3F'   v4

         VRR_E VPERM
         DC    XL16'01FFF9FFFFF803FF FF0506FFFF070600'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'0101F90202F80304 FF0506FFFF070600'   v3
         DC    XL16'1002120304151607 38393A3B3C3D3E3F'   v4
