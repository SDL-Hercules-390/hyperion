 TITLE 'zvector-e6-22-VTZ'
***********************************************************************
*
*        Zvector E6 instruction tests for VRI-L encoded:
*
...
*
***********************************************************************
*  This program tests proper functioning of the z/arch E6 VRI-L vector
*  test zoned. Exceptions are not tested.
*
...
*   R12      E6TESTS 'test address' register
*   R13      (work)
*   R14      Subroutine call
...
**
*        test routine will be here (from VRI_L macro)
* followed by
*        16-byte source v1
*        16-byte source v2
                                                                EJECT
***********************************************************************
* (pending VTZ inclusion in SATK ASAM)
*
*     VTZ Macro to help build VTZ instruction
*        VTZ   V1,V2,i3
*
*        Note: v1 and v2 are fixed vector registers
*              i3 can be specified in hex eg. x'1F1F'
***********************************************************************
         MACRO
         VTZ   &I3
.*                                     &I3  - i3 for VTZ instruction
         LCLA  &V2I3
&V2I3    SETA  +X'200000'+(16*&I3)
                                                               SPACE 1
         DS    0H                      E67F VTZ    - Vector Test Zoned
         DC    X'E6'
         DC    X'01'                   v1
         DC    HL3'&V2I3'              v2, I3, RXB
         DC    X'7F'
                                                               SPACE 1
         MEND
                                                               EJECT
...
*----------------------------------------------------------------------
*     VRI_L Macro to help build test tables
***********************************************************************
         MACRO
         VRI_L &INST,&I3,&CC
...
T&TNUM   DC    A(X&TNUM)         address of test routine
         ...
         DS    XL1'0'            extracted cc (CCFOUND)
         DS    2F'0'             extract PSW after test (CCPSW)
...
X&TNUM   DS    0F
         LGF   R2,REA&TNUM
         VL    V1,0(R2)          get V1 source
         LA    R2,16(R2)
         VL    V2,0(R2)          get V2 source
...
*---------------------------------------------------------------------
* ETS-type-zoned format (embedded trailing sign)
*
* VTZ simple - ssc: 0, ls: 0, dsc: 31, stc: 0, dc: 31
*              Sign: A-F
* digits valid,  sign valid
         VRI_L VTZ,X'1F1F',0
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0A0'   V2 source

         VRI_L VTZ,X'1F1F',0
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0B0'   V2 source

         VRI_L VTZ,X'1F1F',0
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0C0'   V2 source

         VRI_L VTZ,X'1F1F',0
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0D0'   V2 source

         VRI_L VTZ,X'1F1F',0
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0E0'   V2 source

         VRI_L VTZ,X'1F1F',0
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0F0'   V2 source

* digits valid,  sign invalid
         VRI_L VTZ,X'1F1F',1
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F090'   V2 source

* a digit invalid, sign valid
         VRI_L VTZ,X'1F1F',2
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0FF'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0C0'   V2 source

* a digit invalid,  sign invalid
         VRI_L VTZ,X'1F1F',3
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0FF'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F000'   V2 source

* VTZ    - ssc: 0, ls: 0, dsc: 31, stc: 1, dc: 31
*          non zero: Sign: A-F
*---------------------------------------------------------------------
* digits valid,  sign valid
         VRI_L VTZ,X'1F3F',0
...
* digits valid,  sign invalid
         VRI_L VTZ,X'1F3F',1
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F090'   V2 source
...
* digits valid,  sign valid
         VRI_L VTZ,X'1F3F',0
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0A0'   V2 source
         ...
         VRI_L VTZ,X'1F3F',0
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0E0'   V2 source
...
* digits valid,  sign invalid
         VRI_L VTZ,X'1F3F',1
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0B0'   V2 source

         VRI_L VTZ,X'1F3F',1
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0D0'   V2 source

* VTZ    - ssc: 0, ls: 0, dsc: 31, stc: 2, dc: 31
*          Sign: C, D
*---------------------------------------------------------------------
* digits valid,  sign valid
         VRI_L VTZ,X'1F5F',0
...
* VTZ    - ssc: 0, ls: 0, dsc: 31, stc: 3, dc: 31
*          non zero: Sign: C,D
*---------------------------------------------------------------------
* digits valid,  sign valid
         VRI_L VTZ,X'1F7F',0
...
* VTZ    - ssc: 0, ls: 0, dsc: 31, stc: 4, dc: 31
*          Sign: F
*---------------------------------------------------------------------
* digits valid,  sign valid
         VRI_L VTZ,X'1F9F',0
...
* VTZ    - ssc: 0, ls: 0, dsc: 31, stc: 5, dc: 31
*          Sign: F
*---------------------------------------------------------------------
* digits valid,  sign valid
         VRI_L VTZ,X'1FBF',0
...
* VTZ    - ssc: 0, ls: 0, dsc: 31, stc: 6, dc: 31
*          Sign: C,D,F
*---------------------------------------------------------------------
* digits valid,  sign valid
         VRI_L VTZ,X'1FDF',0
...
* VTZ    - ssc: 0, ls: 0, dsc: 31, stc: 7, dc: 31
*          non zero: Sign: C,D,F
*---------------------------------------------------------------------
* digits valid,  sign valid
         VRI_L VTZ,X'1FFF',0
...
*---------------------------------------------------------------------
* SETS-type-zoned format (spaced embedded trailing sign)
*---------------------------------------------------------------------
*
* VTZ simple - ssc: 0, ls: 0, dsc: 3, stc: 0, dc: 31
*              Sign: A-F
* digits valid,  sign valid
         VRI_L VTZ,X'031F',0
         DC    XL16'F0F0F0F0F0F0F0F0 4040404040404040'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0A0'   V2 source
         ...
         VRI_L VTZ,X'031F',0
         DC    XL16'F0F0F0F0F0F0F0F0 4040404040404040'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F34040F0F0F0'   V2 source
...
* a digit invalid, sign valid
         VRI_L VTZ,X'031F',2
         DC    XL16'F0F0F0F0F0F0F0F0 4040404040404040'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F04040C0'   V2 source

         VRI_L VTZ,X'031F',2
         DC    XL16'F0F0F0F0F0F0F0F0 404040404040404F'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0C0'   V2 source

         VRI_L VTZ,X'031F',2
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F04040A0'   V2 source

* a digit invalid,  sign invalid
         VRI_L VTZ,X'031F',3
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0404000'   V2 source

*---------------------------------------------------------------------
* ELS-type-zoned format (embedded leading sign)
*---------------------------------------------------------------------
*
* VTZ simple - ssc: 0, ls: 1, dsc: 31, stc: 0, dc: 31
*              Sign: A-F
* digits valid,  sign valid
         VRI_L VTZ,X'3F1F',0
         DC    XL16'A0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0F0'   V2 source

         VRI_L VTZ,X'3F1F',0
         DC    XL16'B0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0F0'   V2 source

         VRI_L VTZ,X'3F1F',0
         DC    XL16'C0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0F0'   V2 source

         VRI_L VTZ,X'3F1F',0
         DC    XL16'D0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0F0'   V2 source

         VRI_L VTZ,X'3F1F',0
         DC    XL16'E0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0F0'   V2 source
...
*---------------------------------------------------------------------
* STS-type-zoned format (separate trailing sign)
*---------------------------------------------------------------------
*
* VTZ simple - ssc: 1, ls: 0, dsc: 31, stc: 2, dc: 31
*              Sign: x'4E', x'60'
* digits valid,  sign valid
         VRI_L VTZ,X'5F5F',0
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F04E'   V2 source

         VRI_L VTZ,X'5F5F',0
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F060'   V2 source
...
* a digit invalid, sign valid
         VRI_L VTZ,X'5F5F',2
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0FF'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F04E'   V2 source

         VRI_L VTZ,X'5F5F',2
         DC    XL16'40F0F0F0F0F0F0F0 F0F0F0F0F0F0F0FF'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F060'   V2 source
...
*
* VTZ simple - ssc: 1, ls: 0, dsc: 31, stc: 3, dc: 31
*              non-zero Sign: x'4E', x'60'
*---------------------------------------------------------------------
* digits valid,  sign valid
         VRI_L VTZ,X'5F7F',0
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
...
*---------------------------------------------------------------------
* SLS-type-zoned format (separate leading sign)
*---------------------------------------------------------------------
*
* VTZ        - ssc: 1, ls: 1, dsc: 31, stc: 2, dc: 31
*              Sign: x'4E', x'60'
* digits valid,  sign valid
         VRI_L VTZ,X'7F5F',0
         DC    XL16'4EF0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0F0'   V2 source

         VRI_L VTZ,X'7F5F',0
         DC    XL16'60F0F0F0F0F0F0F0 F0F0F0F0F0F0F0F0'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F1F2F3F0F0F0F0F0'   V2 source
...
* a digit invalid, sign valid
         VRI_L VTZ,X'7F5F',2
         DC    XL16'4EF0F0F0F0F0F0F0 F0F0F0F0F0F0F0FF'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F04E'   V2 source

         VRI_L VTZ,X'7F5F',2
         DC    XL16'60F0F0F0F0F0F0F0 F0F0F0F0F0F0F0FF'   V1 source
         DC    XL16'F0F0F0F0F0F0F0F0 F0F0F0F0F0F0F060'   V2 source
...
* VTZ        - ssc: 1, ls: 1, dsc: 31, stc: 3, dc: 31
*              non-zero Sign: x'4E', x'60'
*---------------------------------------------------------------------
* digits valid,  sign valid
         VRI_L VTZ,X'7F7F',0
