 TITLE 'zvector-e6-06-packzonedregister (Zvector E6 VRI-f)'
***********************************************************************
*
*        Zvector E6 instruction tests for VRI-f encoded:
*
*        E670 VPKZR  - VECTOR PACK ZONED REGISTER
*
...
*  pack zoned register instruction. Exceptions are not tested.
*
...
***********************************************************************
*
*   *Testcase VECTOR E6 VPKZR: packed zoned register instruction
*   *
...
V2_&TNUM DC    A(RE&TNUM+16)     address of v2: 16-byte zoned decimal
V3_&TNUM DC    A(RE&TNUM+32)     address of v3: 16-byte zoned decimal
...
X&TNUM   DS    0F
         L     R2,V2_&TNUM       get v2
         VL    V2,0(R2)

         L     R2,V3_&TNUM       get v3
         VL    V3,0(R2)
...
*                                         i4=159(iom=1 & rdc=31)
         ...
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F0F2C2'    V3

         VRI_F VPKZR,159,1,2
         DC    XL16'1230000000000000000000000000122C'    V1
         DC    XL16'F0F1F2F3F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F1F2C2'    V3

         VRI_F VPKZR,159,1,1
         DC    XL16'9870000000000000000000000000123D'    V1
         DC    XL16'F0F9F8F7F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F1F2D3'    V3

         VRI_F VPKZR,159,1,3         (overflow; 1st zone is not 0 )
         DC    XL16'0000000000000000000000000000123D'    V1
         DC    XL16'F9F0F0F0F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F1F2D3'    V3

         VRI_F VPKZR,135,1,3          (overflow; rdc=7 )
         DC    XL16'0000000000000000000000000000123D'    V1
         DC    XL16'F0F9F8F7F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F1F2D3'    V3
         ...
         DC    XL16'0000000000000000000000000000123D'    V1
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F9F0F0F0F0F1F2D3'    V3

         VRI_F VPKZR,142,1,3          (overflow; rdc=14)
         DC    XL16'0000000000000000000000090000123D'    V1
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F0F0F9'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F9F0F0F0F0F1F2D3'    V3

* m5 tests (note: cs is always 1)
*                        m5=1   (nsv=0, nv=0, p1=0, cs=1)
*                        m5=3   (nsv=0, nv=0, p1=1, cs=1)
*                        m5=5   (nsv=0, nv=1, p1=0, cs=1)
*                        m5=7   (nsv=0, nv=1, p1=1, cs=1)
*                        m5=9   (nsv=1, nv=0, p1=0, cs=1)
*                        m5=11  (nsv=1, nv=0, p1=1, cs=1)
*                        m5=13  (nsv=1, nv=1, p1=0, cs=1)
*                        m5=15  (nsv=1, nv=1, p1=1, cs=1)
         ...
         VRI_F VPKZR,159,3,2            p1=1
         DC    XL16'9870000000000000000000000000123F'    V1
         DC    XL16'F0F9F8F7F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F1F2D3'    V3

         VRI_F VPKZR,159,5,3            nv=1 & invalid sign
         DC    XL16'00000000000000000000000000000229'    V1
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F0F292'    V3

         VRI_F VPKZR,159,5,3            nv=1 & invalid digit
         DC    XL16'F0000000000000000000000000000229'    V1
         DC    XL16'F0FFF0F0F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F0F292'    V3

         VRI_F VPKZR,159,7,3            nv=1, p1=1 & invalid digit
         DC    XL16'F870000000000000000000000000123F'    V1
         DC    XL16'F0FFF8F7F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F1F2D3'    V3

         VRI_F VPKZR,159,9,3            nsv=1 & invalid sign
         DC    XL16'00000000000000000000000000000229'    V1
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F0F292'    V3

         VRI_F VPKZR,159,11,3           nsv=1, p1=1 & invalid sign
         DC    XL16'9870000000000000000000000000123F'    V1
         DC    XL16'F0F9F8F7F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F1F293'    V3

         VRI_F VPKZR,159,13,3   nsv=1, nv=1, p1=0 & invalid sign/digit
         DC    XL16'F8700000000000000000000000001239'    V1
         DC    XL16'F0FFF8F7F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F1F293'    V3

         VRI_F VPKZR,159,15,3   nsv=1, nv=1, p1=1 & invalid sign/digit
         DC    XL16'F870000000000000000000000000123F'    V1
         DC    XL16'F0FFF8F7F0F0F0F0F0F0F0F0F0F0F0F0'    V2
         DC    XL16'F0F0F0F0F0F0F0F0F0F0F0F0F0F1F293'    V3
