 TITLE 'zvector-e7-15-ShiftByByte'
***********************************************************************
*
...
*  Shift by Byte (left, right logical, right arithmetic) instructions.
*
...
X&TNUM   DS    0F
         ...
         &INST V22,V22,V23       test instruction (dest is a source)
...
*---------------------------------------------------------------------
         ...
         VRR_C VSLB
         DC    XL16'FFFFFFFFFFFFFFFF FF09FFFFFFFFFFFF'   result
         DC    XL16'FFFFFFFFFFFFFFFF FF09FFFFFFFFFFFF'   v2
         DC    XL16'0000000000000000 0000000000000000'   v3

         VRR_C VSLB
         DC    XL16'FFFFFFFFFFFFFFFF 09FFFFFFFFFFFF00'   result
         DC    XL16'FFFFFFFFFFFFFFFF FF09FFFFFFFFFFFF'   v2
         DC    XL16'FFFFFFFFFFFFFF08 FFFFFFFFFFFFFFFF'   v3

         VRR_C VSLB
         DC    XL16'0F00000000000000 0000000000000000'   result
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   v2
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v3

         VRR_C VSLB
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFF0000'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09010 7060504030201000'   v3

         VRR_C VSLB
         DC    XL16'9080706050403020 1000000000000000'   result
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   v2
         DC    XL16'0000000000000030 0000000000000000'   v3
...
*---------------------------------------------------------------------
         ...
         VRR_C VSRLB
         DC    XL16'00FFFFFFFFFFFFFF FFFF09FFFFFFFFFF'   result
         DC    XL16'FFFFFFFFFFFFFFFF FF09FFFFFFFFFFFF'   v2
         DC    XL16'FFFFFFFFFFFFFF08 FFFFFFFFFFFFFFFF'   v3

         VRR_C VSRLB
         DC    XL16'0000000000000000 0000000000000080'   result
         DC    XL16'8001020304050607 08090A0B0C0D0E0F'   v2
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v3

         VRR_C VSRLB
         DC    XL16'0000FFFFFFFFFFFF FFFFFF09FFFFFFFF'   result
         DC    XL16'FFFFFFFFFFFFFFFF FF09FFFFFFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09010 7060504030201000'   v3

         VRR_C VSRLB
         DC    XL16'000000000000F0E0 D0C0B0A090807060'   result
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   v2
         DC    XL16'0000000000000030 0000000000000000'   v3
...
*---------------------------------------------------------------------
         ...
         VRR_C VSRAB
         DC    XL16'FFFFFFFFFFFFFFFF FFFF09FFFFFFFFFF'   result
         DC    XL16'FFFFFFFFFFFFFFFF FF09FFFFFFFFFFFF'   v2
         DC    XL16'FFFFFFFFFFFFFF08 FFFFFFFFFFFFFFFF'   v3
         ...
         VRR_C VSRAB
         DC    XL16'000040FFFFFFFFFF FFFFFFFFFFFFFFFF'   result
         DC    XL16'40FFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09010 7060504030201000'   v3

         VRR_C VSRAB
         DC    XL16'00000000000070E0 D0C0B0A090807060'   result
         DC    XL16'70E0D0C0B0A09080 7060504030201000'   v2
         DC    XL16'0000000000000030 0000000000000000'   v3
