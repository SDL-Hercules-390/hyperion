...
*  logical (and, and with complement, or, nor, not xor, xor, nand)
*  instructions.
*
...
***********************************************************************
         ...
         FCHECK 135,'z/Arch vector enhance facility 1'
                                                                EJECT
***********************************************************************
...
*---------------------------------------------------------------------
         ...
         VRR_C VN
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   v3

         VRR_C VN
         DC    XL16'F0E0D000B0A09000 7060500030201000'   result
...
*---------------------------------------------------------------------
         ...
         VRR_C VNC
         DC    XL16'0F1F2F3F4F5F6F7F 8F9FAFBFCFDFEFFF'   result
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   v3

         VRR_C VNC
         DC    XL16'0F1F2F004F5F6F00 8F9FAF00CFDFEFFF'   result
         DC    XL16'FFFFFF00FFFFFF00 FFFFFF00FFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   v3
...
*---------------------------------------------------------------------
         ...
         VRR_C VO
         DC    XL16'FFFFFFC0FFFFFF80 FFFFFF40FFFFFFFF'   result
         DC    XL16'FFFFFF00FFFFFF00 FFFFFF00FFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   v3
...
*---------------------------------------------------------------------
         ...
         VRR_C VNO
         DC    XL16'0000003F0000007F 000000BF00000000'   result
         DC    XL16'FFFFFF00FFFFFF00 FFFFFF00FFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   v3
...
*---------------------------------------------------------------------
         ...
         VRR_C VNX
         DC    XL16'F0E0D03FB0A0907F 706050BF30201000'   result
         DC    XL16'FFFFFF00FFFFFF00 FFFFFF00FFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   v3
...
*---------------------------------------------------------------------
         ...
         VRR_C VX
         DC    XL16'FFFEFDFCFBFAF9F8 F7F6F5F4F3F2F1F0'   result
         DC    XL16'0001020304050607 08090A0B0C0D0E0F'   v2
         DC    XL16'FFFFFFFFFFFFFFFF FFFFFFFFFFFFFFFF'   v3
         ...
         VRR_C VX
         DC    XL16'0F1F2FC04F5F6F80 8F9FAF40CFDFEFFF'   result
         DC    XL16'FFFFFF00FFFFFF00 FFFFFF00FFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   v3
...
*---------------------------------------------------------------------
         ...
         VRR_C VNN
         DC    XL16'0F1F2FFF4F5F6FFF 8F9FAFFFCFDFEFFF'   result
         DC    XL16'FFFFFF00FFFFFF00 FFFFFF00FFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   v3
...
*---------------------------------------------------------------------
         ...
         VRR_C VOC
         DC    XL16'FFFFFF3FFFFFFF7F FFFFFFBFFFFFFFFF'   result
         DC    XL16'FFFFFF00FFFFFF00 FFFFFF00FFFFFFFF'   v2
         DC    XL16'F0E0D0C0B0A09080 7060504030201000'   v3
