...
int sizeof_cmd( int argc, char* argv[], char* cmdline )
{
    ...
    WRMSG( HHC02257, "I", "STFL_MAX_BITS........", (int) STFL_MAX_BITS           );
    WRMSG( HHC02257, "I", "STFL_NUM_HERC_BITS...", (int) STFL_NUM_HERC_BITS      );
    ...
    WRMSG( HHC02257, "I", "STFL_MAX_DW..........", (int) STFL_MAX_DW             );
    WRMSG( HHC02257, "I", "STFL_MAX_BYTES.......", (int) STFL_MAX_BYTES          );
