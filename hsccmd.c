...
int sizeof_cmd( int argc, char* argv[], char* cmdline )
{
    ...
    WRMSG( HHC02257, "I", "STFL_IBMMAX .......", (int)STFL_IBMMAX);
    WRMSG( HHC02257, "I", "STFL_IBMBYSIZE.....", (int)STFL_IBMBYSIZE);
    WRMSG( HHC02257, "I", "STFL_IBMDWSIZE.....", (int)STFL_IBMDWSIZE);
    WRMSG( HHC02257, "I", "STFL_HERCBITS......", (int)STFL_HERCBITS);
    WRMSG( HHC02257, "I", "STFL_HERCMAX.......", (int)STFL_HERCMAX);
    WRMSG( HHC02257, "I", "STFL_HERCBYSIZE....", (int)STFL_HERCBYSIZE);
    WRMSG( HHC02257, "I", "STFL_HERCDWSIZE....", (int)STFL_HERCDWSIZE);
