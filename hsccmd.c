...
int sizeof_cmd( int argc, char* argv[], char* cmdline )
{
    ...
    WRMSG( HHC02257, "I", "STFL_MAX_BITS........", STFL_MAX_BITS                 );
    WRMSG( HHC02257, "I", "STFL_NUM_HERC_BITS...", STFL_NUM_HERC_BITS            );
    WRMSG( HHC02257, "I", "STFL_IBM_LAST_BIT....", STFL_IBM_LAST_BIT             );
    WRMSG( HHC02257, "I", "STFL_HERC_FIRST_BIT..", STFL_HERC_FIRST_BIT           );
    WRMSG( HHC02257, "I", "STFL_HERC_LAST_BIT...", STFL_HERC_LAST_BIT            );
    WRMSG( HHC02257, "I", "STFL_MAX_DW..........", STFL_MAX_DW                   );
    WRMSG( HHC02257, "I", "STFL_MAX_BYTES.......", STFL_MAX_BYTES                );
    WRMSG( HHC02257, "I", "STFL_IBM_DW_SIZE.....", STFL_IBM_DW_SIZE              );
    WRMSG( HHC02257, "I", "STFL_HERC_DW_SIZE....", STFL_HERC_DW_SIZE             );
    WRMSG( HHC02257, "I", "STFL_HERC_BY_SIZE....", STFL_HERC_BY_SIZE             );
