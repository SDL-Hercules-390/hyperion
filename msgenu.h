...
#define HHC01407 "Usage: %s [--help[=SHORT|LONG]] [-f config-filename] [-o logfile-name] [-r rcfile-name] [-d] [-b logo-filename] [-s sym=val] [-t [factor]] [-p dyn-load-dir] [[-l dynmod-to-load]...] [> logfile]"
