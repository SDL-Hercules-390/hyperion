...
/*-------------------------------------------------------------------*/
static inline void ARCH_DEP( vstore2_full )( U16 value, VADR addr, int arn, REGS* regs )
{
...
/*      exception, and in this case the function does not return.    */
/*-------------------------------------------------------------------*/
static inline void ARCH_DEP( vstore4_full )( U32 value, VADR addr, int arn, REGS* regs )
{
BYTE   *main1, *main2;                  /* Mainstor addresses        */
BYTE   *sk;                             /* Storage key addresses     */
...
/*-------------------------------------------------------------------*/
static inline void ARCH_DEP( vstore8_full )( U64 value, VADR addr, int arn, REGS* regs )
{
BYTE   *main1, *main2;                  /* Mainstor addresses        */
BYTE   *sk;                             /* Storage key addresses     */
int     len;                            /* Length to end of page     */
...
/*      exception, and in this case the function does not return.    */
/*-------------------------------------------------------------------*/
static inline U16 ARCH_DEP( vfetch2_full )( VADR addr, int arn, REGS* regs )
{
...
/*      exception, and in this case the function does not return.    */
/*-------------------------------------------------------------------*/
static inline U32 ARCH_DEP( vfetch4_full )( VADR addr, int arn, REGS* regs )
{
BYTE   *mn;                             /* Main storage addresses    */
int     len;                            /* Length to end of page     */
...
/*      exception, and in this case the function does not return.    */
/*-------------------------------------------------------------------*/
static inline U64 ARCH_DEP( vfetch8_full )( VADR addr, int arn, REGS* regs )
{
BYTE   *mn;                             /* Main storage addresses    */
int     len;                            /* Length to end of page     */
...
/*-------------------------------------------------------------------*/
DLL_EXPORT // (needed by dyncrypt.c)
inline void ARCH_DEP( vstorec )( const void* src, BYTE len, VADR addr, int arn, REGS* regs )
{
BYTE   *main1, *main2;                  /* Mainstor addresses        */
BYTE   *sk;                             /* Storage key addresses     */
...
/*-------------------------------------------------------------------*/
DLL_EXPORT // (needed by dyncrypt.c)
inline void ARCH_DEP( vfetchc )( void* dest, BYTE len, VADR addr, int arn, REGS* regs )
{
...
/*-------------------------------------------------------------------*/
DLL_EXPORT // (needed by dyncrypt.c)
inline void ARCH_DEP( validate_operand )( VADR addr, int arn, int len,
