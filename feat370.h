...
#define FEATURE_ETF2_ENHANCEMENT_FACILITY
#define FEATURE_ETF3_ENHANCEMENT_FACILITY
#define FEATURE_EXECUTE_EXTENSIONS_FACILITY
#define FEATURE_EXTENDED_IMMEDIATE_FACILITY
#define FEATURE_EXTENDED_TRANSLATION_FACILITY_3
#define FEATURE_GENERAL_INSTRUCTIONS_EXTENSION_FACILITY
#define FEATURE_LONG_DISPLACEMENT_FACILITY
